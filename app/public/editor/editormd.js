; (function (factory) {
  ...
  editormd.prototype = editormd.fn = {
    ...
    setToolbar: function () {
      ...
      var toolbarMenu = toolbar.find('.' + this.classPrefix + 'menu'); var menu = '';
      var pullRight = false;
     ...
     * 解析Markdown代码为html
     *
     * @returns {htmlString}     返回html字符串
     */
    getHtmlFromMarkDown: function (markdown) {
      var settings = this.settings;
      var cm = this.cm;
      var cmValue = markdown || cm.getValue();
  ...
  editormd.createDialog = function (options) {
    ...
    if (options.title !== '' && options.drag) {
      ...
      var moveAction = function (e) {
        ...
        var left; var top; var nowLeft = parseInt(dialog[0].style.left); var nowTop = parseInt(dialog[0].style.top);
