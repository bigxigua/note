...
export default class ImageUploader extends Component {
    ...
    initializeDragHandle = () => {
        ...
        dragArea.ondrop = function (e) {
            ...
            let files = Array.of(e.dataTransfer.files).splice(0 ,3);
            const { fileList } = ctx.state;
    ...
    render() {
                ...
                <li className="image-preview-file" key={file.fileId}>
                    ...
                    <div className="image-preview-info">
                        ...
                        <div>
                            ...
                            <div className={linkClassName} onClick={(e) => { this.onCopyLinkHandle(file) }}><Icon type="link" />复制链接</div>
                        </div>
                    </div>
                </li>
            );
        ...
        return (
            <div className={coverClassName}>
                <div className={modalClassName} ref="dragArea">
                            ...
                            <div className="image-preview-container">
                                ...
                                <div className="image-preview-footer">
                                    ...
                                    <div className="image-preview-footer-buttons">
                                        <Button disabled={disabledChoseImage} type="dashed" onClick={this.onChoseImageHandle} className="image-uploader-button">
                                            <input type="file" onChange={this.handleChange}></input>继续添加
                                        </Button>
                                        <Button disabled={disabledUploader} type="primary" loading={uploadLoading} onClick={this.onStartUploaderHandle}>开始上传</Button>
                                    </div>
                                </div>
                            </div>
                        )}
